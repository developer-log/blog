  ...
  return {
    ...
    projects: {
      ...
      interquesty: {
        ...
        long: {
          1: "Interquesty — приложение, которое я сделал пару дней для собственного пользования. Дело в том что во время интервью не всегда удобно быстро придумывать новые вопросы для кандидата, держать список с вопросами в заметках оказалось не так удобно, как я думал. Именно в тот момент мне и пришла идея придумать приложение, которое бы имело разнообразный список вопросов с короткими ответами на них.",
