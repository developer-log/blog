  ...
  return {
    ...
    projects: {
      interquesty: {
        ...
        long: {
          1: "Interquesty - гэта праграма, якую я стварыў для ўласнага карыстання некалькі дзён таму. Справа ў тым, што падчас гутаркі не заўсёды зручна хутка прыдумляць кандыдату новыя пытанні; весці спіс пытанняў у нататках аказалася не так зручна, як я думаў. У гэты момант мне прыйшла ў галаву ідэя прыдумаць дадатак, у якім быў бы разнастайны спіс пытанняў з кароткімі адказамі на іх.",
