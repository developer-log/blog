  ...
  return {
    ...
    projects: {
      ...
      interquesty: {
        ...
        long: {
          1: "Interquesty - бұл бір-екі күн бұрын жеке пайдалану үшін жасаған қолданба. Әңгімелесу кезінде үміткерге жаңа сұрақтарды тез қою әрқашан қолайлы бола бермейді; сұрақтар тізімін жазбаларда сақтау мен ойлағандай ыңғайлы емес болып шықты. Дәл сол кезде маған қысқа жауаптары бар сұрақтардың әртүрлі тізімі болатын қосымшаны ойлап табу идеясы келді.",
